...
This is convenient, although it contrasts with the usual execution for normal Jolie services, which is set to [single](../basics/composing_statements/#statement-execution-operators)
