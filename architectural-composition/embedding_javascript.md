...
Let us rewrite the [_twice_ service example](https://jolielang.gitbook.io/docs/architectural_composition/embedding_jolie.md) as a JavaScript embedded service.
