...
In Jolie there is not the need to change any code in the behaviour because there is a clear separation between the logical and physical layer of the service
...
Now lets us look to the orchestrator
