...
SSL \(Secure Sockets Layer\) is not a communication protocol on its own and it is used as a wrapping for SSL-based secure protocols, like [SODEPS](./sodeps/README.md) and [HTTPS](../ssl/https/README.md).
