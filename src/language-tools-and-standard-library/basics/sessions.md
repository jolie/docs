...
A concrete example of that is operation `in` of the Console service, which, as seen in the [example section on communication ports](../basics/communication-ports/a_comprehensive_example.md), receives inputs from the standard input.
