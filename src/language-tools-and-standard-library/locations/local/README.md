...
An example using this medium can be found in part "Handling structured messages and embedder's operations invocation" of [Embedding Java Services](../../technology-integration/java/javaservices/README.md) subsection.
