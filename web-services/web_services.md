...
To invoke a web service's operation, we need to create a compatible Jolie interface. To do that we exploit the tool [wsdl2jolie](https://github.com/jolielang/docs/tree/de0bcc5b82206ed6be6cb78fa10f6068bbe5881c/documentation/web_services/wsdl2jolie.html), which is part of the Jolie trunk installation.
...
To expose the port `MyServiceSOAPPort` as a web service, we exploit the tool [jolie2wsdl](https://github.com/jolielang/docs/tree/de0bcc5b82206ed6be6cb78fa10f6068bbe5881c/documentation/web_services/jolie2wsdl.html) that generates the corresponding WSDL document to be attached to the file:
