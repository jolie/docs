...
The `TypeMismatch` fault can be handled by exploiting the [fault handling](https://jolielang.gitbook.io/docs/basics/fault_handling/basics), as shown in the following example:
